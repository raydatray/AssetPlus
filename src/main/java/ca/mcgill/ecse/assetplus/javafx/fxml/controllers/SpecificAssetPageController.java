...
public class SpecificAssetPageController {
  ...
  void updateSpecificAsset(ActionEvent event) {
      ...
      try {
          ...
          String result = AssetPlusFeatureSet3Controller.updateSpecificAsset(assetNumber, newFloorNumber, newRoomNumber, new Date(LocalDate.now().toEpochDay()), newAssetTypeName );
...
@FXML
void deleteSpecificAsset(ActionEvent event) {
