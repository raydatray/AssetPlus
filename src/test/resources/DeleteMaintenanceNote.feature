Feature: Delete Note
  ...
  Background: 
    ...
    Given the following notes exist in the system:
      ...
      |  3 | manager@ams.com |        1 |  2023-09-23 | This is a dummy description 1              |
  ...
  Scenario Outline: Successfully delete a note for a maintenance ticket in the system
    ...
    Examples: 
      ...
      |  1 |        2 | eff@ams.com     | 2023-09-01 | This is a dummy note 1 for a ticket.       |
      |  2 |        1 | smith@yahoo.com | 2023-09-10 | This is another dummy note 2 for a ticket. |
  ...
  Scenario Outline: Unsuccessfully delete a maintenance note from the system.
    ...
    Examples: 
      ...
      |  1 |        2 | dummy@ams.com     | 2023-09-23 | This is a dummy description 1 | User does not exist in the system    |
      |  4 |        1 | eff@ams.com       | 2023-09-23 | This is a dummy description 1 | Note does not exist in the system    |
      |  1 |        9 | manager@yahoo.com | 2023-10-05 | This is a dummy description 2 | Ticket does not exist in the system. |
