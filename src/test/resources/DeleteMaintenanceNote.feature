Feature: Delete Note
  ...
  Scenario Outline: Successfully delete a note for a maintenance ticket in the system
    When the manger attempts to delete note number "<noteIndex>" for maintenance ticket "<ticketId>"
    ...
    Then the note number "<noteIndex>" for ticket <ticketId> shall not exist in the system
