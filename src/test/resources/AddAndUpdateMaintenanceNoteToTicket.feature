Feature: Add/Update Note
  ...
  Background: 
    ...
    Given the following manager exist in the system:
      | email           | password | name  | phoneNumber   |
      | manager@ams.com | secret   | Tofic | (123)456-7891 |
    ...
    Given the following notes exist in the system:
      ...
      |  1 | eff@ams.com     |        2 |  2023-09-01 | This is a dummy note 1 for a ticket.       |
      |  2 | smith@yahoo.com |        1 |  2023-09-10 | This is another dummy note 2 for a ticket. |
  ...
  Scenario Outline: Successfully add a note to a maintenance ticket to the system by an employee
    ...
    Examples: 
      ...
      |  3 |        1 | jeff@ams.com    | 2023-09-23 | This is a dummy description 1 |
      |  3 |        1 | smith@yahoo.com | 2023-10-05 | This is a dummy description 2 |
  ...
  Scenario Outline: Successfully add a note to a maintenance ticket to the system by the manager
    ...
    Examples: 
      | id | ticketId | noteTaker       | date       | description                   |
      |  3 |        1 | manager@ams.com | 2023-09-23 | This is a dummy description 1 |
  ...
  Scenario Outline: Unsuccessfully add a maintenance note to the system.
    ...
    Examples: 
      ...
      |  3 |        1 | abdul@ams.com     | 2023-09-23 | This is a dummy description 1 | User does not exist in the system.   |
      |  3 |        3 | manager@yahoo.com | 2023-10-05 | This is a dummy description 2 | Ticket does not exist in the system. |
  ...
  Scenario Outline: Successfully update a note information.
    ...
    Examples: 
      ...
      |  1 | eff@ams.com   | eff@ams.com     |           2 |           2 |     2023-09-01 |     2023-09-20 | This is a dummy note 1 for a ticket.       | This is new dummy note |
      |  2 | smith@ams.com | manager@ams.com |           1 |           1 |     2023-09-10 |     2023-09-20 | This is another dummy note 2 for a ticket. | This is new dummy note |
  ...
  Scenario Outline: Unsuccessfully update a note with invalid information
    ...
    Examples: 
      ...
      |  3 | eff@ams.com     | eff@ams.com     |           2 |           2 |     2023-09-01 |     2023-09-20 | This is a dummy note 1 for a ticket.       | This is new dummy note | Note does not exist in the system |
      |  2 | smith@ams.com   | manager@ams.com |           1 |           1 |     2023-09-10 |     2023-09-20 | This is another dummy note 2 for a ticket. |                        | Description can not be empty      |
      |  1 | manager@ams.com | manager@ams.com |           1 |           1 |     2023-09-10 |     2023-09-20 | This is another dummy note 2 for a ticket. |                        | Old note taker is incorrect       |
