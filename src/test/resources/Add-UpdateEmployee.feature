Feature: Add/Update Employee
  ...
  Scenario Outline: An employee registers unsuccessfully
    ...
    Examples: 
      ...
      | owen@ap.com    | pass10   |      | (888)888-5555    | Name cannot be empty                        |
      | noah@ap.com    | pass11   | Noah |                  | Phone number cannot be empty                |
  ...
  Scenario Outline: An employee updates their info successfully
    ...
    Then the number of employee in the system shall be "2"
  ...
  Scenario Outline: An employee updates their info unsuccessfully
    When the employee with "<email>" attempts to update their account information to "<newPassword>", "<newName>", and "<newPhoneNumber>"
    Then the following "<error>" shall be raised
    Then the employee account information will not be updated and will keep "<email>", "<password>", "<name>", and "<phoneNumber>"
    Then the number of employee in the system shall be "2"
    ...
    Examples: 
      ...
      | john@ap.com | pass2    | John | (444)444-4444 | pass2       |         | (444)444-7777  | Name cannot be empty              |
      | john@ap.com | pass2    | John | (444)444-4444 | pass2       | John    |                | Emergency contact cannot be empty |
