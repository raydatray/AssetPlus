...
public class DeleteAssetTypeStepDefinitions {
	...
	/**
	 * Calls the deleteAssetType controller method to delete the asset type with the
	 * input name
	 * 
	 * @param assetType
	 */
	...
	/**
	 * Checks that the number of asset types in the system is equal to the expected
	 * input number
	 * 
	...
	public void the_following_asset_types_shall_exist_in_the_system_p4(io.cucumber.datatable.DataTable dataTable) {
		...
		for (Map<String, String> row : rows) {
			...
			// Checks that the assetType object with the input name exists with the corresponding life span
