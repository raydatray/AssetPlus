...
public class DeleteMaintenanceNoteStepDefinitions {
  ...
  public void the_manger_attempts_to_delete_note_number_for_maintenance_ticket_p2(String string,
      String string2) {
	  int noteNumber = Integer.parseInt(string);
	  int ticketNumber = Integer.parseInt(string2);
	  
	  if (ticketNumber < assetPlus.getMaintenanceTickets().size()) {
		  MaintenanceTicket ticket = assetPlus.getMaintenanceTicket(ticketNumber-1);
	    if (noteNumber < ticket.getTicketNotes().size()) {
	      deletedNote = assetPlus.getMaintenanceTicket(ticketNumber-1).getTicketNote(noteNumber);
	    }
	  }
  ...
  public void the_number_of_notes_in_the_system_shall_be_p2(String string) {
	  int expectedNumber = Integer.parseInt(string);
  ...
  public void the_number_of_notes_for_ticket_in_the_system_shall_be_p2(String string,
      String string2) {
	int ticketNumber = Integer.parseInt(string);
	int expectedNumber = Integer.parseInt(string2);
  ...
  public void the_note_number_for_ticket_shall_not_exist_in_the_system_p2(String string,
      Integer int1) {
    
	  int noteNumber = Integer.parseInt(string);
	  int ticketNumber = int1;
