...
public class DeleteMaintenanceTicketStepDefinitions {
  ...
  public void the_following_tickets_exist_in_the_system_p7(
    ...
    for (var row: rows){
      ...
      AssetPlusFeatureSet4Controller.addMaintenanceTicket(aID, dateRaised, description, aTicketRaiserEmail, assetID);
    }
  }
  /**
  ...
  public void the_following_tickets_shall_exist_in_the_system_p7(
    ...
    for (Map<String, String> ticket: ticketTable){
      ...
      try {
        currentDate = (java.util.Date) new SimpleDateFormat("yyyy-MM-dd").parse(ticket.get("raisedOnDate"));
